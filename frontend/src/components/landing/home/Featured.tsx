...
export default function WhoCanUseSection() {
  const sectors = [
    ...
    },
    {
      ...
      title: "Warehouses",
      description: "Full inventory and storage monitoring with bin location tracking and automated stock movements.",
      benefits: ["Storage monitoring", "Location tracking", "Stock movements"]
    }
  ];
      ...
      <div className=" mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Who Can Use IzubaSystem?
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            IzubaSystem supports businesses of all sectors with tailored inventory management solutions designed to meet your unique operational needs.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                No matter what sector you're in, IzubaSystem adapts to your workflow. Say goodbye to stock errors, manual tracking, and spreadsheet chaos.
              </p>
        ...
        <div className="mt-16 bg-white rounded-3xl p-12 shadow-sm">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              IzubaSystem is a comprehensive stock management solution built for businesses that want to move beyond Excel sheets and manual tracking. Whether you run a small boutique or manage multiple warehouse locations, our platform provides real-time visibility, automated alerts, and powerful reporting tools.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              With support for unlimited products, multi-branch operations, and role-based access control, IzubaSystem scales with your business. Our system integrates seamlessly into your existing workflow, helping you reduce waste, prevent stockouts, and make data-driven decisions that drive growth.
            </p>
