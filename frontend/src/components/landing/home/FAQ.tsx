...
export default function FAQAccordion() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, we offer a generous free trial period so you can thoroughly explore Mysystem before making any financial commitment. During the trial, you'll have full access to all premium features including inventory management, sales tracking, reporting tools, multi-branch capabilities, offline mode, and customer support. This gives you ample time to test the system with your actual business data, train your staff, and ensure that Mysystem meets all your specific requirements. There's no credit card required to start the trial, and you won't be automatically charged when the trial ends. We believe in letting our product speak for itself, and we're confident that once you experience the efficiency and power of Mysystem, you'll want to continue using it to grow your business. Our support team is also available during your trial to help you get set up and answer any questions."
    },
    {
    ...
    <div className=" bg-neutral-100 p-6 flex items-center justify-center">
      <div className="w-full max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">Everything you need to know about Mysystem</p>
        </div>
