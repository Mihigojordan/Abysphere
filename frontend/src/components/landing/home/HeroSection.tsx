...
const HRExcellenceHero = () => {
  ...
  const slides = [
    {
      title: "Smart Stock Management for Every Business",
      subtitle: "Track your inventory, suppliers, purchases, sales, and stock movements — all in one simple, powerful system.",
      stat: "300+",
          ...
          >
            <div className="grid lg:grid-cols-2 h-full">
              ...
              <div className="flex flex-col justify-center px-16 lg:px-24 py-16">
                ...
                {/* CTA Buttons */}
                <div
                  className={`transition-all duration-700 delay-400 flex gap-4 ${
                    currentSlide === index && isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
                  }`}
                >
                  ...
                  <button className="px-8 py-4 bg-white text-slate-900 font-semibold rounded border-2 border-slate-900 hover:bg-slate-900 hover:text-white transition-all duration-300">
                    Request a Demo
                  </button>
                </div>
