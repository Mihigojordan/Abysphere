...
class AdminAuthService {
  ...
  async registerAdmin(adminData: AdminData): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/register', adminData);
  ...
  async adminLogin(loginData: LoginData): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/login', loginData);
      return response.data;
    } catch (error: any) {
  ...
  async verifyOTP(data: OTPVerifyData): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/verify-otp', data);
      return response.data;
    } catch (error: any) {
  ...
  async logout(): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/logout');
      return response.data;
    } catch (error: any) {
  ...
  async getAdminProfile(): Promise<AuthResponse | null> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.get('/super-admin/profile');
      return response.data;
    } catch (error: any) {
  ...
  async lockAdmin(): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/lock');
      return response.data;
    } catch (error: any) {
  ...
  async unlockAdmin(unlockData: UnlockData): Promise<AuthResponse> {
    try {
      const response: AxiosResponse<AuthResponse> = await this.api.post('/super-admin/unlock', unlockData);
      return response.data;
    } catch (error: any) {
  ...
  async findAdminByEmail(email: string): Promise<Admin | null> {
    try {
      const response: AxiosResponse<Admin> = await this.api.get(`/super-admin/by-email/${email}`);
      return response.data;
    } catch (error: any) {
      if (error.response?.status === 404) return null;
  ...
  async findAdminById(id: string): Promise<Admin | null> {
    try {
      const response: AxiosResponse<Admin> = await this.api.get(`/super-admin/${id}`);
      return response.data;
    } catch (error: any) {
      if (error.response?.status === 404) return null;
      const msg = error.response?.data?.message || error.message || 'Failed to find admin';
  ...
  async deleteAdmin(id: string): Promise<{ message: string }> {
    try {
      const response: AxiosResponse<{ message: string }> = await this.api.delete(`/super-admin/${id}`);
      return response.data;
    } catch (error: any) {
  ...
  async changePassword(data: ChangePasswordData): Promise<{ message: string }> {
    try {
      const response: AxiosResponse<{ message: string }> = await this.api.patch('/super-admin/change-password', data);
      return response.data;
    } catch (error: any) {
