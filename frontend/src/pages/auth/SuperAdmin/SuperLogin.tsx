        ...
        <div className="relative bg-white backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-blue-600 text-sm font-semibold tracking-wider">SUPER ADMIN PORTAL</span>
            </div>
            ...
            <p className="text-gray-600 text-sm">
              {isOTPRequired ? "Enter the code sent to your email" : "Sign in to access super admin dashboard"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-primary-500 text-white py-3.5 px-4 rounded-xl font-semibold hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
            >
