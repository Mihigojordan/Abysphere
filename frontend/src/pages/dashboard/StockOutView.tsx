...
const StockOutView: React.FC<StockOutViewProps> = ({ role: initialRole }) => {
    ...
    const companyName = (adminData as any)?.companyName ?? 'PMS Technologies';
    ...
    return (
        <div className="so-view-container">
            <style>{`
                ...
                .brand-mark { display: flex; align-items: center; gap: 12px; margin-bottom: 20px; }
                .brand-icon {
                ...
                .brand-icon svg { width: 8px; height: 8px; color: #fff; }
                .brand-name {
                ...
                <div className="doc">
                        ...
                        <div>
                            ...
                            <div className="company-meta">
                                <div className="meta-row">
                                    ...
                                    {(adminData as any)?.companyAddress ?? 'Kigali, Rwanda'}
                                </div>
                                <div className="meta-row">
                                    ...
                                    {(adminData as any)?.companyPhone ?? '+250 788 000 000'}
                                </div>
                                <div className="meta-row">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                                    {(adminData as any)?.adminEmail ?? 'info@pms.rw'}
                                </div>
                                <div className="meta-tin">
                                    ...
                                    TIN: &nbsp;{(adminData as any)?.companyTin ?? '123 456 789'}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="parties">
                        <div>
                            ...
                            <p className="party-name">{companyName}</p>
                            <p className="party-detail">
                                {(adminData as any)?.companyAddress ?? 'Kigali, Rwanda'}<br />
                                {(adminData as any)?.adminEmail ?? 'info@pms.rw'}<br />
                                {(adminData as any)?.companyPhone ?? '+250 788 000 000'}
                            </p>
                        </div>
                        <div>
