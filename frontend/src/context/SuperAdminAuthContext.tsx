...
import adminAuthService from '../services/SuperAdminAuthService';
...
export const SuperAdminAuthContextProvider: React.FC<AdminAuthContextProviderProps> = ({ children }) => {
  ...
  const loginWithGoogle = (popup = false, uri: string | null = null) => {
    ...
    const googleUrl = uri ? `${API_URL}/super-admin/google?state=${stateParam}` : `${API_URL}/admin/google`;
